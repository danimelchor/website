                    ...
                    <div className="block my-5 bg-white dark:bg-gray-900 dark:text-gray-50 rounded p-5 md:p-10 shadow-2xl overflow-hidden">
                        <div className="my-5">
                            ...
                            <p className="xl:inline-block text-lg xl:text-xl leading-10 xl:ml-12 text-justify align-middle xl:w-1/2 my-10 xl:my-0">
                                Hi! My name is Daniel, and I am an 18-year-old studying Computer Science at Boston University.
                        ...
                        <div className="my-5 align-middle">
                            <img src={meSergio} className="xl:float-right xl:w-5/12 xl:inline-block xl:h-1/4 align-middle"/>
                            <div className="xl:inline-block text-lg xl:text-xl leading-10 xl:mr-12 align-middle text-justify xl:w-1/2 my-10 xl:my-0">
                                <p className="my-4" >
                                ...
                                <p className="my-4" >
                                    ...
                                    the <a href="#contact" className="text-green-500 hover:text-secondary dark:text-secondaryDark dark:hover:text-primaryDark">contact section</a>!
                                </p>
                                <p className="my-4" >
                                    My current focus is placed on finishing my <a className="text-green-500 hover:text-secondary dark:text-secondaryDark dark:hover:text-primaryDark" href="https://www.bu.edu/academics/cas/programs/computer-science/ba-ms/">
                                    ...
                                    registration tool to give it a modern design and new functionality. Check it out <a className="text-green-500 hover:text-secondary dark:text-secondaryDark dark:hover:text-primaryDark" href="http://bunexus.com">here</a>.
                                </p>
                            </div>
                        </div>
                    </div>
