...
Then, clone this repository into a folder in your computer using git (Open terminal, `cd` into your folder and run `git clone --single-branch --branch main https://github.com/danimelchor/website/` and then `cd` into the website folder where the React App is located (`cd website`).
