...
Then, clone this repository into a folder in your computer using git (Open terminal, `cd` into your folder and run `git clone https://github.com/danimelchor/website/`.
