  ...
  return (
    ...
    >
      ...
      <p className="text-slate-600 dark:text-slate-400 w-full lg:w-1/2">
        I absolutely love connecting with new people! Whether you have a burning question,
        want to bounce around some ideas, or just fancy a friendly chat - count me in!
        I'm all ears for new opportunities, collaborations, or a simple hello.
      </p>
