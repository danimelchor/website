    ...
    render() {
        return (
            <div className="p-10 my-5 lg:my-0 bg-white dark:bg-gray-800 dark:text-gray-50 w-5/6 lg:w-2/5 lg:mx-5 rounded shadow-2xl">
                <h2 className="uppercase text-2xl text-primary hover:text-secondary dark:text-gray-400 dark:hover:text-secondaryDark font-mono italic" ><a href={this.props.url} target="_blank">// {this.props.school}</a></h2>
