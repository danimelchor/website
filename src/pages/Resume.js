        ...
        return (
            <div id="resume" className="w-full mb-24" style={{height: "40vh"}}>
                ...
                <div className="py-10 px-2 m-auto w-full md:w-5/6">
                    <a href={ResumePdf} className="block my-5 bg-white dark:bg-gray-800 dark:text-secondaryDark rounded p-5 shadow-2xl text-green-500 hover:text-secondary dark:text-secondaryDark dark:hover:text-primaryDark">
