...
export default function Project({ languages, title, img, date, url }) {
  ...
  return (
    ...
    >
      <div className="relative h-6 w-full bg-gray-800">
        <h2
          className="absolute inline-block align-middle transform overflow-hidden -translate-x-2/4 text-gray-100"
          style={{ left: "50%" }}
        >
          {title}
        </h2>
      ...
      <div className="relative">
        ...
        <div
          className="absolute top-0 w-full h-full transition-opacity flex flex-col items-center justify-center bg-gray-900 bg-opacity-90 z-30 opacity-0 group-hover:opacity-100"
          style={
        ...
        >
          ...
          <div className="p-5 flex flex-col w-full items-center justify-center">
            <a
              href={url}
              className="px-3 py-2 rounded-full border-2 bg-gray-800 my-2 text-white hover:bg-opacity-50 transform hover:scale-110 transition-transform hover:border-secondaryDark w-4/5 sm:w-3/4 2xl:w-1/2 flex items-center justify-center"
            >
            ...
            <Link
              ...
              className="px-3 py-2 rounded-full border-2 bg-gray-800 my-2 text-white hover:bg-opacity-50 transform hover:scale-110 transition-transform hover:border-secondary hover:border-secondaryDark w-4/5 sm:w-3/4 2xl:w-1/2 flex items-center justify-center"
            >
