    ...
    render() {
        return (
            <div id="experience" className="w-full mb-24">
                <h1 className="px-10 py-10 w-full text-black text-4xl titleSection bg-primary dark:bg-gray-900 text-center md:text-left">Experience</h1>
                <div className="py-10 px-2 m-auto w-full md:w-5/6">
                    <div className="block my-5 bg-white dark:bg-gray-900 dark:text-gray-50 rounded p-10 shadow-2x0l text-justify">
                        <p className="text-lg xl:text-xl leading-10">
                            ...
                            you are interested in learning more about them, check out my <a className="text-green-500 hover:text-secondary dark:text-secondaryDark dark:hover:text-primaryDark" href="https://www.linkedin.com/in/dannymelchor/">LinkedIn</a>.
                        </p>
                    </div>
                </div>
            </div>
