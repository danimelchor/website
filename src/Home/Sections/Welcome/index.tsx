...
export default function Welcome() {
  const [buttonText, setButtonText] = useState<string | React.ReactNode>("Say Hello");
  ...
  return (
    <div>
      ...
      >
        ...
        <h1
          className="w-11/12 text-center md:w-auto text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl 3xl:text-9xl font-black text-white transition-colors duration-200"
          id="home-title"
        >
          Daniel Melchor
        </h1>
        <h2
          className="w-11/12 font-serif text-center md:w-auto text-xl 2xl:text-2xl 3xl:text-3xl italic text-gray-300 transition-colors duration-200"
          id="home-subtitle"
        >
      ...
      <div
        className="w-full flex items-center justify-center absolute left-0 text-gray-400 text-3xl z-50 transform -translate-y-full"
        style={{ top: "99vh" }}
      >
        <Link
          to="about"
